...
check('description kombiniert Meteotext, Auswirkungen und Empfehlungen', str_contains($result[0]['description'], 'Nordwestwind') && str_contains($result[0]['description'], 'herabstürzen') && str_contains($result[0]['description'], 'achtsam'));
check('description beginnt mit meteotext (meteorologische Kurzerklärung zuerst)', str_starts_with($result[0]['description'], 'Mit einer nordwestlichen Strömung'));
