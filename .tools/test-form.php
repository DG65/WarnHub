...
check('nennt alle sieben mobilen-Standort-Quellen namentlich (Tessie, Geofency, Stellantis Vehicles, Smartcar, BMW Connected Drive, Hyundai/Kia Bluelink, OVMS native)', str_contains($standorteText, 'Tessie') && str_contains($standorteText, 'Geofency') && str_contains($standorteText, 'Stellantis Vehicles') && str_contains($standorteText, 'Smartcar') && str_contains($standorteText, 'BMW Connected Drive') && str_contains($standorteText, 'Hyundai/Kia Bluelink') && str_contains($standorteText, 'OVMS native'));
check('nennt die GitHub-Fundstellen der vier nicht im Store-Suchnamen eindeutigen Community-Module', str_contains($standorteText, 'github.com/slausch/Symcon-Stellantis-Vehicles') && str_contains($standorteText, 'github.com/mb-stern/Smartcar') && str_contains($standorteText, 'github.com/da8ter/Bluelink') && str_contains($standorteText, 'github.com/lorbetzki/net.lorbetzki.native.ovms'));
