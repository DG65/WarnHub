...
check('Markise Terrasse -> MinSeverity 2 (Moderate, windempfindlicher als Raffstore -- reagiert auf die eigene Wetterstation schon ab der niedrigsten Windstufe)', ($byName['Markise Terrasse']['MinSeverity'] ?? null) === 2);
check('Raffstore Wohnzimmer -> weiterhin MinSeverity 3 (Severe, robuster als Markise)', ($byName['Raffstore Wohnzimmer']['MinSeverity'] ?? null) === 3);
